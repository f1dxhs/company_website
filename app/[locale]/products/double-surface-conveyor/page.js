...
export default function DoubleBeltConveyorPage() {
  ...
  const projectScenarios = [
    ...
    {
      title: 'Mine Retrofit Project',
      image: 'https://images.unsplash.com/photo-1624365168968-f3de91617742?w=800&h=600&fit=crop',
      capacity: 'Increased production',
      length: 'Existing tunnels',
      description: 'No infrastructure modifications needed'
    },
    {
      title: 'Material Separation System',
      image: 'https://images.unsplash.com/photo-1581092335397-9583eb92d232?w=800&h=600&fit=crop',
      capacity: 'Dual streams',
      length: 'Reduced width',
      description: 'Efficient transport of different materials'
    }
  ]
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src="https://images.unsplash.com/photo-1574482620826-40685ca5ebd2?w=1920&h=1080&fit=crop"
