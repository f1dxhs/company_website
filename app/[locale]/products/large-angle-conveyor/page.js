...
export default function LargeAngleConveyorPage() {
  ...
  const projectScenarios = [
    {
      title: 'Limestone Quarry in Mexico',
      image: 'https://images.unsplash.com/photo-1547751550-b62e1c2e4355?w=800&h=600&fit=crop',
      capacity: '1,200 m³/h',
      angle: '65°',
      description: 'Vertical lift system for limestone extraction'
    },
    {
      title: 'Coal Mine in Poland',
      image: 'https://images.unsplash.com/photo-1516937941344-00b4e0337589?w=800&h=600&fit=crop',
      capacity: '800 m³/h',
      angle: '75°',
      description: 'Underground to surface coal transportation'
    },
    {
      title: 'Iron Ore Terminal in India',
      image: 'https://images.unsplash.com/photo-1581833971358-2c8b550f87b3?w=800&h=600&fit=crop',
      capacity: '1,500 m³/h',
      angle: '55°',
      description: 'Ship loading conveyor system with steep incline'
    }
  ]
